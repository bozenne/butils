...
#' @importFrom stats as.formula coef cov cov2cor delete.response formula IQR lm mad median model.frame model.matrix na.omit optim qnorm quantile sd setNames terms time update qt
