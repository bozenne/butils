...
ggSurv.data.table <- function(object, format = "data.table",
  ...
  ## check object
  validCharacter(value1 = timeVar, name1 = "timeVar", validLength = 1, validValues = object.name, method = "ggSurv.dt")
  validCharacter(value1 = survivalVar, name1 = "survivalVar", validLength = 1, validValues = object.name, method = "ggSurv.dt")
  validCharacter(value1 = ciInfVar, name1 = "ciInfVar", validLength = 1, refuse.NULL = confint, validValues = object.name, method = "ggSurv.dt")
  validCharacter(value1 = ciSupVar, name1 = "ciSupVar", validLength = 1, refuse.NULL = confint, validValues = object.name, method = "ggSurv.dt")
  validCharacter(value1 = eventVar, name1 = "eventVar", validLength = 1, refuse.NULL = events, validValues = object.name, method = "ggSurv.dt")
  validCharacter(value1 = censorVar, name1 = "censorVar", validLength = 1, refuse.NULL = censoring, validValues = object.name, method = "ggSurv.dt")
  validCharacter(value1 = strataVar, name1 = "strataVar", validLength = 1, refuse.NULL = FALSE, validValues = object.name, method = "ggSurv.dt")
