...
test_that("lm", {
  ...
  expect_equal(names(coef(res)), c("(Intercept)","X4","X5"), tol = 1e-3)
  expect_equal(as.double(coef(res)["(Intercept)"]),0, tol = 1e-3)
  expect_equal(coef(res)[c("X4","X5")],coef(lm.full)[c("X4","X5")], tol = 1e-3)
  
  res <- partialModel(lm.full, var1 = "X1", var2 = "X5")
  expect_equal(names(coef(res)), c("(Intercept)","X12","X13","X5"), tol = 1e-3)
  expect_equal(as.double(coef(res)["(Intercept)"]),0, tol = 1e-3)
  expect_equal(coef(res)[c("X12","X13","X5")],coef(lm.full)[c("X12","X13","X5")], tol = 1e-3)
  
  res <- partialModel(lm.full, var1 = "X2", var2 = "X3")
  expect_equal(names(coef(res)), c("(Intercept)","X2b","X3"), tol = 1e-3)
  expect_equal(as.double(coef(res)["(Intercept)"]),0, tol = 1e-3)
  expect_equal(coef(res)[c("X2b","X3")],coef(lm.full)[c("X2b","X3")], tol = 1e-3)
  
  res <- partialModel(lm.full, var1 = "X1", var2 = "X2")
  expect_equal(names(coef(res)), c("(Intercept)","X12","X13","X2b","X12:X2b","X13:X2b"), tol = 1e-3)
  expect_equal(as.double(coef(res)["(Intercept)"]),0, tol = 1e-3)
  expect_equal(coef(res)[c("X12","X13","X2b","X12:X2b","X13:X2b")],coef(lm.full)[c("X12","X13","X2b","X12:X2b","X13:X2b")], tol = 1e-3)
})
# }}}
